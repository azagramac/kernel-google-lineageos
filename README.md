...
| `vendor_boot.img` | Contains **vendor kernel**, **vendor initramfs** (initramfs for vendor boot), optional **DTB**, and vendor modules. | Generated by AOSP with `TARGET_BOOTIMAGE_TARGETS=vendor_bootimage` or `build_<codename>.sh`     |
